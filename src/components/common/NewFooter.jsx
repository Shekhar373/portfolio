...
export default function Footer() {
  return (
    <div className="min-h-[60vh] md:h-[90vh] w-full relative flex justify-center items-center mt-[10vh] md:mt-[20vh]">
      <footer className="min-h-[48vh] md:h-[80vh] w-[98%] sm:w-[95%] rounded-xl bg-[#090909] text-zinc-400 text-2xl sm:text-4xl md:text-5xl sticky bottom-0 flex flex-col justify-between py-6 md:py-0">
        ...
        {/* Bottom Title */}
        <div className="h-[16vh] md:h-[40%] px-5 w-full flex  justify-center items-end bg-gradient-to-b from-zinc-600 to-zinc-800 bg-clip-text text-transparent ">
          <h1 className="text-[9.5vw] mb-2 sm:mb-3 md:mb-5 text-center">
            NEW HUE STUDIO
          </h1>
        </div>
      </footer>
