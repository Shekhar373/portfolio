...
const Fullscreennav = () => {
  ...
  return (
    <div ref={container} className="lg:hidden">
      ...
      <div
        ref={nav}
        className="fullnav fixed top-0 left-0 w-screen h-screen bg-[#181818] text-[#EBEAE4] flex flex-col justify-between py-0 px-5 pb-[8vh]"
      ...
      >
        ...
        <div className="flex gap-4 py-5 w-full items-center ">
          ...
          <a href="www.linkedin.com/in/new-hue-studio-8017b43b6">
            <img
              className="h-10 w-10 "
