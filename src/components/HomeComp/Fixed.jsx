  ...
  return (
    <div>
      <div className='nav relative flex justify-between lg:p-10 max-sm:p-3 text-white'>
          <div className='cursor-pointer fixed mix-blend-difference z-50'>
            <Link className=' transition-all' to="/">The Growth Accelerator</Link>

          </div>
          <div className='flex gap-3 lg:flex fixed right-72 z-50 mix-blend-difference cursor-pointer max-sm:hidden '>
          ...
          <div className='cursor-pointer z-50 mix-blend-difference fixed right-5' >
