...
const Fixed = () => {
  ...
  return (
    <div>
      <div className='nav relative w-full font-[heading-font] text-xl flex p-5 lg:p-10 text-white'>
          ...
          <div className='md:flex  gap-3 lg:flex fixed lg:right-10 md:right-40 z-40 mix-blend-difference cursor-pointer hidden md:visible'>
